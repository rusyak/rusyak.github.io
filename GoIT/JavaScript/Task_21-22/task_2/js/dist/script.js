...
var checkResults = function checkResults(e) {
  ...
  var $body = $('body');
  if (testOK) {
    $modal = '<div class="mymodal"><div class="mymodal-inner"><h1 class="text-center">You passed the test!</h1><h1 class="text-center">Right is ' + answered + ', from ' + questionsQuantity + '</h1><p class="text-center"><img src="img/icon-good.png"></p><a class="center-block btn btn-primary" id="exit">Exit</a></div></div>';
  } else {
    $modal = '<div class="mymodal"><div class="mymodal-inner"><h1 class="text-center">You didn\'t pass the test!</h1><h1 class="text-center">Right is ' + answered + ', from ' + questionsQuantity + '</h1><p class="text-center"><img src="img/icon-bad.png"></p><a class="center-block btn btn-primary" id="exit">Exit</a></div></div>';
  }
