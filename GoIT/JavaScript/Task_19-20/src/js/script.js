...
function namesSort() {
    ...
    for (var k = 0; k < names.length; k++) {
      names[k].friends = names[k].friends.length;
  }
...
function friendsSort() {
    ...
    for (var n = 0; n < data.length; n++) {
      for (var j = 0; j < data[n].friends.length; j++) {
        allFriends.push( data[n].friends[j].name);
    }
}
...
console.log('Массив скиллов всех людей: ', skillsSort());
console.log('Массив имен людей: ', namesSort());
console.log('Массив всех друзей всех пользователей: ', friendsSort());
